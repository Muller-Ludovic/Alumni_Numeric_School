...
<main>
  ...
  <div class="divh2"><h2><strong>Poster une actualité</strong></h2></div>
  <hr>
  <form action="#" method="POST">
  <div class="divh3co spantel"><h3><strong><input type="text" name="titre_offre" placeholder="Titre actualité"></strong></h3></div>
